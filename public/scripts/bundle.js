...
var HangmanGame = function () {
  function HangmanGame(word, remainingGuesses) {
  ...
  _createClass(HangmanGame, [{
    key: "solvePuzzle",
    value: function solvePuzzle(letter) {
      var _this = this;
      ...
      var word = "";
      var isUnique = !this.guesses.includes(letter);
      var isGoodGuess = this.word.includes(letter);
      ...
      this.word.forEach(function (letter) {
        if (_this.guesses.includes(letter)) {
          word += letter;
        } else {
          word += "*";
        }
    ...
    value: function getStatus() {
      ...
      completed = this.word.every(function (letter) {
        return _this2.guesses.includes(letter);
      });
...
window.addEventListener("keydown", function (e) {
  (0, _views.resetLetterGuess)(e.key);
  (0, _views.render)();
});
...
var getPuzzle = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(wordCount) {
    var responseObject, puzzleObject;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            puzzleObject = _context.sent;
            return _context.abrupt("return", puzzleObject.puzzle);

          case 10:
            throw new (Error(_templateObject))();
...
exports.resetLetterGuess = exports.resetWord = exports.render = undefined;

var _requests = __webpack_require__(/*! ./requests.js */ "./source/requests.js");

var _requests2 = _interopRequireDefault(_requests);

var _hangman = __webpack_require__(/*! ./hangman.js */ "./source/hangman.js");
...
var remainingGuessesEl = document.querySelector("#remaining_guesses");
var word1 = void 0;
var letterGuess = void 0;
...
var render = function render() {
  ...
  word1.solvePuzzle(letterGuess).split("").forEach(function (letter) {
    if (letter !== " ") {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            wordValue = _context.sent;

            //make word 1 that new puzzle value
            word1 = new _hangman2.default(wordValue, 6);
...
var resetLetterGuess = function resetLetterGuess(key) {
  letterGuess = key;
};

exports.render = render;
exports.resetWord = resetWord;
exports.resetLetterGuess = resetLetterGuess;
